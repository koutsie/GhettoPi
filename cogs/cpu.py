...
class CPU:
    ...
    async def uptime(self, ctx):
        ...
        embed = discord.Embed(title="CPU", description="Displays thr cpu information.", colour=0xFF5722)
        ...
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/350607106044592132/479189377508048897/kernal2048kek.png")
