...
async def on_ready():
    ...
    print("Logged into", len(client.guilds), "servers")
    while True:
        servers = str(len(client.guilds))
        users = str(len(set(client.get_all_members())))
        await client.change_presence(activity=discord.Game(name=' Bootup: See logs!', type=1, url='https://twitch.tv/koutsie'))
        await asyncio.sleep(20)
        await client.change_presence(activity=discord.Game(name='over ' + servers + ' shards...', type=2, url='https://opi,koutsie.eu/'))
        await asyncio.sleep(20)
        await client.change_presence(activity=discord.Game(name='the ' + users + ' users', type=2, url='https://opi,koutsie.eu/'))
        await asyncio.sleep(20)
        await client.change_presence(activity=discord.Game(name='logs...', type=2, url='https://opi,koutsie.eu/'))
        await asyncio.sleep(30)
        await client.change_presence(activity=discord.Game(name=' https://opi.koutsie.eu/', type=2, url='https://https://opi,koutsie.eu/'))
        await asyncio.sleep(20)
